...
You need a private key generated by @<sub>byte</sub> Team for you, key_id and team_id to communicate with APNS servers on behalf of @<sub>byte</sub> app bundle, email us for ones: arobyte at arobyte.org, then configure your hub (conf.js or conf.json) to enable notifications.
